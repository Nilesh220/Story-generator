...
item = {
    ...
    'name': 'saloni',
    'views': 198,
    'poster': 'task 2/story_posters/06_saloni_198_poster.jpg',
    'time': '10:48',
    'silent': True,
    'battery': 64,
    'signal': 4,
...
crop_style = {'name': 'below_donut', 'ratio': 2.02}
...
print(f"\n Saloni (198 views) generated successfully in '{output_dir}'!")

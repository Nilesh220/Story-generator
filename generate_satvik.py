...
item = {
    'id': '07_276_satvik_singh',
    'name': 'satvik_singh',
    'views': 276,
    'poster': 'task 2/story_posters/07_satvik_singh_276_poster.jpg',
    'time': '02:35',
    'silent': True,
    'battery': 81,
    'signal': 4,
...
print(f"\n Satvik Singh (276 views) generated successfully in '{output_dir}'!")

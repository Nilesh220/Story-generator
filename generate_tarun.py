...
item = {
    ...
    'name': 'tarun',
    'views': 515,
    'poster': 'task 2/story_posters/05_tarun_515_poster.jpg',
    'time': '09:24',
    'silent': True,
    'battery': 77,
    'signal': 4,
...
crop_style = {'name': 'below_donut', 'ratio': 2.04}
...
print(f"\n Tarun (515 views) generated successfully in '{output_dir}'!")
